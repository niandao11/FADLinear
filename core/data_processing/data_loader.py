...
def _target_last_columns(df_raw, target):
...
class Dataset_ETT_SAW(Dataset):
    FEATURE_COLS = ['HUFL', 'HULL', 'MUFL', 'MULL', 'LUFL', 'LULL', 'OT']

    def __init__(self, root_path, flag='train', size=None,
                 features='MS', data_path='ETTm2_5min_SAW.csv',
    ...
    def __read_data__(self):
        ...
        border1s = [0, num_train - self.seq_len, total_len - num_val - self.seq_len]
        ...
        if self.features == 'M' or self.features == 'MS':
            ...
            cols = [c for c in self.FEATURE_COLS if c in df_raw.columns]
            if self.target not in cols:
                raise ValueError(f"Target column '{self.target}' not found in SAW columns: {cols}")
        ...
        if self.timeenc == 0:
            ...
            df_stamp['minute'] = df_stamp.date.dt.minute // 5
...
class Dataset_ETT_hour(Dataset):
    ...
    def __read_data__(self):
        ...
        if self.features == 'M' or self.features == 'MS':
            cols_data = _target_last_columns(df_raw, self.target)
...
class Dataset_Custom(Dataset):
    ...
    def __read_data__(self):
        ...
        cols = _target_last_columns(df_raw, self.target)
...
class Dataset_Pred(Dataset):
    ...
    def __read_data__(self):
        ...
        self.border1s = [border1]
        self.border2s = [border2]
